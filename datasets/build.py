...
def build_CLIP_IQA_dataset(config, num):
    ...
    elif config.DATA.DATASET == "cviu17":
        if num == 1:
            train_dataset = CVIU17DATASET_clip(
                config.DATA.DATA_PATH,
                config.SET.TRAIN_INDEX,
                config.DATA.PATCH_NUM,
                transform=build_clip_transform1(config),
    ...
    elif config.DATA.DATASET == "sisar":
        if num == 1:
            train_dataset = SISARDATASET_clip(
                config.DATA.DATA_PATH,
                config.SET.TRAIN_INDEX,
                config.DATA.PATCH_NUM,
                transform=build_clip_transform1(config),
    ...
    elif config.DATA.DATASET == "qads":
        if num == 1:
            train_dataset = QADSDATASET_clip(
                config.DATA.DATA_PATH,
                config.SET.TRAIN_INDEX,
                config.DATA.PATCH_NUM,
                transform=build_clip_transform1(config),
    ...
    elif config.DATA.DATASET == "waterloo15":
        if num == 1:
            train_dataset = WATERLOO15DATASET_clip(
                config.DATA.DATA_PATH,
                config.SET.TRAIN_INDEX,
                config.DATA.PATCH_NUM,
                transform=build_clip_transform1(config),
...
def build_dataloader(config, dataset_name, dataset_path, batch_size, test_index):
    ...
    elif dataset_name == "cviu17":
        test_dataset = CVIU17DATASET_clip(
            dataset_path,
            test_index,
            config.DATA.PATCH_NUM,
            transform=build_clip_transform2(config)
        )
    elif dataset_name == "sisar":
        test_dataset = SISARDATASET_clip(
            dataset_path,
            test_index,
            config.DATA.PATCH_NUM,
            transform=build_clip_transform2(config)
        )
    elif dataset_name == "qads":
        test_dataset = QADSDATASET_clip(
            dataset_path,
            test_index,
            config.DATA.PATCH_NUM,
            transform=build_clip_transform2(config)
